...
export async function runTestFile(options, collectSpecData) {
...
export async function runWorkflow({ workflowInput, ctx, fromStepId, skipLineSeparator, parentStepId, invocationContext, }) {
...
async function handleDependsOn({ workflow, ctx, config, }) {
    if (!workflow.dependsOn?.length)
        return;

export { type CollectFn, type Exact, keysOf, readFileFromUrl, slash, doesYamlFileExist, isTruthy, pause, isPlainObject, isString, dequal, pluralize, isEmptyObject, isNotEmptyArray, isNotEmptyObject, } from './utils.js';
...
export { type RawUniversalConfig, type RawUniversalApiConfig, type ResolvedConfig, type ResolvedApiConfig, type Plugin, type RuleConfig, Config, // FIXME: export it as a type
IGNORE_FILE, loadConfig, findConfig, CONFIG_FILE_NAME, type RuleSeverity, createConfig, ConfigValidationError, resolvePlugins, } from './config/index.js';
...
export { type SpecMajorVersion, getMajorSpecVersion, type SpecVersion, detectSpec, getTypes, } from './oas-types.js';

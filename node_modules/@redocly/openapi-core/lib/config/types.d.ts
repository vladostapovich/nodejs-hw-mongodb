...
import type { BuiltInOAS2RuleId, BuiltInOAS3RuleId, BuiltInAsync2RuleId, BuiltInAsync3RuleId, BuiltInArazzo1RuleId, BuiltInOverlay1RuleId, BuiltInCommonRuleId } from '../types/redocly-yaml.js';
...
export type RawUniversalApiConfig = ApiConfig & RawGovernanceConfig & {
    plugins?: (string | Plugin)[];
};
export type ResolvedApiConfig = ApiConfig & Required<ResolvedGovernanceConfig>;
export type RawUniversalConfig = Omit<Partial<RedoclyConfig>, 'apis' | 'plugins'> & RawGovernanceConfig & {
    plugins?: (string | Plugin)[];
    apis?: Record<string, RawUniversalApiConfig>;
    resolve?: RawResolveConfig;
    telemetry?: Telemetry;
};
export type ResolvedConfig = Omit<RawUniversalConfig, 'apis' | 'plugins'> & ResolvedGovernanceConfig & {
